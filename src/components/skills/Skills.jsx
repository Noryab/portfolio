...
const Skills = () => {
  return (
    <div
      id="skills"
      className="pl-10 pt-10 pr-10 pb-16 bg-gradient-to-tr md:m-auto h-auto sm:h-screen w-screen sm:w-screen bg-fixed bg-cover bg-center from-[#37718c] to-[#2e8bbd]"
    >
