...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="bg-gradient-to-tr h-auto w-auto sm:h-auto sm:w-screen bg-fixed bg-cover bg-center from-[#1d1d1d] to-[#abb3cd]"
    >
      <div className="max-w-[1240px] sm:py-10 m-auto flex flex-col sm:flex-row justify-center items-center">
